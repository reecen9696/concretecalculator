...
export function ResidencyStep({ errors }: { errors: StepErrors }) {
  ...
  return (
    <div className="form-section">
      <h2 className="subtitle">Are you an Australian resident or permanent visa holder?</h2>
...
export function IncomeStep({ errors }: { errors: StepErrors }) {
  ...
  return (
    <div className="form-section">
      <h2 className="subtitle">Annual household income</h2>
      {INCOME.map(({ v, l }) => (
        <RadioRow
          key={v}
          name="income"
...
export function EmploymentStep({ errors }: { errors: StepErrors }) {
  ...
  return (
    <div className="form-section">
      <h2 className="subtitle">Employment status</h2>
      {EMPLOYMENT.map(({ v, l }) => (
        <RadioRow
          key={v}
          name="employment"
...
export function BankruptcyStep({ errors }: { errors: StepErrors }) {
  ...
  return (
    <div className="form-section">
      <h2 className="subtitle">Have you declared bankruptcy in the last 5 years?</h2>
